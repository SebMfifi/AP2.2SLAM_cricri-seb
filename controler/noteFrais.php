...
$requeteNoteFrais = $conn->prepare("SELECT MATRICULE, IDNOTEFRAIS, sn.IDSTATUTS, LIBELLESTATUTS, DATEEDITNOTE FROM REALISER r INNER JOIN STATUS_NOTE sn ON r.IDSTATUTS = sn.IDSTATUTS WHERE MATRICULE=:mat;");
...
//echo "MATRICULE, IDNOTEFRAIS, IDSTATUTS, DATEEDITNOTE";
